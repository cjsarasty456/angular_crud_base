...
public class productoController {
	...
	public ResponseEntity<Object> guardarProducto(Productos producto) {

		producto.setImagen_url("http://localhost:8080/api/downloadFile/");
	...
	@PutMapping("/{id}")
	public ResponseEntity<Object> actualizarProducto(@PathVariable String id, Productos producto) {
		producto.setImagen_url("http://localhost:8080/api/downloadFile/" );
		int retorno = service.guardar(producto);
		if (retorno == 0) {
			respuesta respuesta = new respuesta(
	 ...
	 * @PostMapping("/")
	 * //eliminar @RequestBody
	 * public ResponseEntity<Object> guardarProductoJson(Productos
	 * producto, @RequestParam("file") MultipartFile file) throws IOException {
	 * 
	 * try {
